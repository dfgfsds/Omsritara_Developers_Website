...
export default function ProjectPage() {
    ...
    const stats = [
        ...
        { label: "Completed", value: projects.filter(p => p.category === "completed").length, icon: CheckCircle },
        { label: "Ongoing", value: projects.filter(p => p.category === "ongoing").length, icon: TrendingUp },
    ...
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                        {stats.map((stat, index) => (
                            ...
                            >
                                <stat.icon className="w-8 h-8 md:w-10 md:h-10 mx-auto mb-3 text-[#9b0000]" />
            ...
            {/* Filter Tabs */}
            <section className="py-8 md:py-10 bg-white sticky border-b">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-evenly md:justify-center gap-4">
                        {[
                            ...
                            <button
                                ...
                                className={`px-6 py-2.5 md:px-8 md:py-3 rounded-full font-semibold text-sm md:text-base uppercase transition-all duration-300 ${activeFilter === filter.key
                                ...
                                >
                                    ...
                                    <div className="p-6 flex flex-col flex-grow">
                                        ...
                                        <div className="flex items-start gap-2 text-gray-600 mb-4">
                                            <MapPin className="w-4 h-4 mt-1 flex-shrink-0 text-[#e29717]" />
                                        ...
                                        <div className="flex items-start gap-2 mb-4">
                                            <Calendar className="w-4 h-4 mt-0.5 text-[#9b0000]" />
                                        ...
                                        <button className="w-full mt-auto relative inline-flex items-center justify-center bg-[#9b0000] text-white font-semibold uppercase rounded-full pl-6 pr-2 py-2 gap-3 group/btn overflow-hidden">
                                            ...
                                            <span className="absolute top-0 left-[-100%] w-full h-full bg-[#e29717] transition-all duration-500 group-hover/btn:left-0 z-0"></span>
                                        </button>
                                    </div>
                                </div>
                            ))}
